...
int main(){
  ...
  std::cout << "\n\nFirst Quantile: ";
  for (unsigned int i = 3*(quantLen/4); i != quantLen; ++i){
    std::cout <<  Numbers[i] << "  ";
  }
  std::cout << "\n\n" << std::endl;
  std::cout << "Second Quantile: ";
  for (unsigned int i = 2*(quantLen/4); i != 3*(quantLen/4); ++i){
    std::cout <<  Numbers[i] << "  ";
  }
  std::cout << "\n\n" << std::endl; 
  std::cout << "Third Quantile: ";
  for (unsigned int i = quantLen/4; i != 2*(quantLen/4); ++i){
    std::cout <<  Numbers[i] << "  ";
  }
  std::cout << "\n\n" << std::endl; 
  std::cout << "Final Quantile: ";
  for (unsigned int i = 0; i != quantLen/4; ++i){
    std::cout <<  Numbers[i] << "  ";
  }
  std::cout << "\n\n" << std::endl; 
  return(0); 
